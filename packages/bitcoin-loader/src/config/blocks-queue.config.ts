...
export class BlocksQueueConfig {
  ...
  @IsString()
  BITCOIN_LOADER_BLOCKS_QUEUE_LOADER_STRATEGY_NAME: string = 'pull-network-provider-by-batches';
  ...
  @IsNumber()
  BITCOIN_LOADER_BLOCKS_QUEUE_LOADER_MAX_INTERVAL_MS: number = 10 * 60 * 1000; // Bitcoin block time
  ...
  @IsNumber()
  BITCOIN_LOADER_BLOCKS_QUEUE_ITERATOR_BLOCKS_BATCH_SIZE: number = 1 * 1024 * 1024;
}
